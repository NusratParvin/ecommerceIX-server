...
router.get("/subscribers ", (0, auth_1.default)(client_1.UserRole.ADMIN), users_controllers_1.UserControllers.fetchAllSubscribers);
...
router.post("/subscribe", users_controllers_1.UserControllers.addSubscriber);
router.delete("/unsubscribe/:id", users_controllers_1.UserControllers.removeSubscriber);
